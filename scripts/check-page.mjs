...
if (window.__api) {
  ...
  // The digression: an author's folder, and a tune in it.
  ...
  check($('sessiontitle').textContent === 'Browsing author — Trio'
        && $('playlistname').textContent === 'Browsing',
    'and the heading says whose folder this is');
