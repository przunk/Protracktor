/* What autoconf would have produced for sc68 3.0.0b, written by hand -- the Android copy.
 *
 * Kept beside the host probe's copy in native/probe/sc68/generated/ rather than shared with it,
 * because the two genuinely differ: this machine has no zlib development package and Android's NDK
 * ships one. A single file with an #ifdef would hide that difference rather than state it.
 *
 *
